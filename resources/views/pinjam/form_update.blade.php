        ...
        <div class="card">
            <div class="card card-primary">
                ...
                <div class="card-header">
                    <h3 class="card-title">Update Data Pinjam : {{ $pinjam->nomor_pinjam  }}</h3>
                </div>
                <form method="POST" action="{{ route('update_pinjam',['id' => $pinjam->nomor_pinjam ]) }}" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group" >
                                    ...
                                    <input type="text" class="date  form-control" id="txttgl" name="txttgl"  autocomplete="off" value="{{ date('d-m-Y',strtotime($pinjam->tanggal)) }}">
                                </div>
                                <div class="form-group" >
                                    <label for="exampleInputEmail1">Estimasi Kembali</label>
                                    <input type="text"  class="date form-control" id="txttglest" name="txttglest"  value="{{ date('d-m-Y',strtotime($pinjam->tgl_kembali)) }}"  autocomplete="off">
                                </div>
                                <!-- <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="txtket" name="txtket" placeholder="Keterangan   " autocomplete="off">{{ $pinjam->keterangan }}</textarea>
                                    </div>
                            </div>
                        </div>
                        <div class="row">
